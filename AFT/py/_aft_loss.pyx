...
def negative_gradient(cnp.npy_double[:] y_lower,
    ...
    cdef cnp.ndarray[cnp.npy_double, ndim=1] gradient   = cnp.PyArray_EMPTY(1, &n, cnp.NPY_DOUBLE, 0)
    cdef cnp.ndarray[cnp.npy_double, ndim=1] event      = cnp.PyArray_EMPTY(1, &n, cnp.NPY_DOUBLE, 0)
    cdef cnp.ndarray[cnp.npy_double, ndim=1] sigma_rep  = np.repeat(sigma,n)
    cdef cnp.ndarray[cnp.npy_double, ndim=1] dist_rep   = np.repeat(dist,n)
