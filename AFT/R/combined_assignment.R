...
distribution.list = list(gaussian=list(uncensored_l=loss(type="uncensored",t.lower=100,t.higher=100,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='normal'),
                         ...
                         logistic=list(uncensored_l=loss(type="uncensored",t.lower=100,t.higher=100,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='logistic'),
                                       left_l=loss(type="left",t.lower=-Inf,t.higher=20,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='logistic'),
                                       right_l=loss(type="right",t.lower=60,t.higher=Inf,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='logistic'),
                                       interval_l=loss(type="interval",t.lower=16,t.higher=200,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='logistic'),
                         ...
                         extreme=list(uncensored_l=loss(type="uncensored",t.lower=100,t.higher=100,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='extreme'),
                                      left_l=loss(type="left",t.lower=-Inf,t.higher=20,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='extreme'),
                                      right_l=loss(type="right",t.lower=60,t.higher=Inf,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='extreme'),
                                      interval_l=loss(type="interval",t.lower=16,t.higher=200,sigma=1,y.hat=2**(seq(1,x.lim,length=n.points)),dist='extreme'),
